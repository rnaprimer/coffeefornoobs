...
export default function GearSection() {
  return (
    <section className="bg-brand-pink flex-1 lg:w-1/2 p-8 lg:p-12 relative overflow-hidden flex flex-col justify-center border-b lg:border-b-0 border-brand-dark">
      ...
      <div className="hidden xl:flex absolute right-4 lg:right-12 top-1/2 -translate-y-1/2 w-[280px] h-[320px] bg-brand-white border border-brand-dark rotate-2 items-center justify-center text-center p-4 z-0">
